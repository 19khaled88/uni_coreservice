...
const route_11 = __importDefault(require("./app/modules/offeredCourseSection/route"));
const route_12 = __importDefault(require("./app/modules/classSchedule/route"));
...
app.use('/api/v1/offeredCourseSection', route_11.default);
app.use('/api/v1/classSchedule', route_12.default);
app.get('/', (req, res) => {
