...
const createRoom = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const checkIfExist = yield prisma.room.findFirst({
        where: {
            AND: [{ roomNumber: data.roomNumber }, { floor: data.floor }],
        },
    });
    if (checkIfExist) {
        throw new ApiError_1.default(400, "Already posted same room");
    }
    const res = yield prisma.room.create({ data });
    if (!res) {
        throw new Error("Failed to create room");
    }
    return res;
});
const allrooms = (paginationOptions, filter) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andCondition.push({
            OR: constants_1.roomSearchableFields.map((item) => {
                return {
                    [item]: {
                        contains: searchTerm,
                        mode: "insensitive",
    ...
    const res = yield prisma.room.findMany({
...
const singleRoom = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield prisma.room.findFirst({
        where: {
            id: id,
        },
        select: {
...
const updateRoom = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield prisma.room.findFirst({
        where: {
            id: id,
        },
    });
    if (!isExist) {
        throw new ApiError_1.default(400, "This room not exist");
    }
    const response = yield prisma.room.update({
        where: {
            id: id,
        },
        data: payload,
...
const deleteRoom = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = yield prisma.room.delete({
        where: {
            id: id,
        },
    });
