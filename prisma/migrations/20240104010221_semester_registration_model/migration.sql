...
-- DropEnum
DROP TYPE "SemesterCode";

-- DropEnum
DROP TYPE "SemesterTitle";
...
-- AddForeignKey
ALTER TABLE "semester_registration" ADD CONSTRAINT "semester_registration_academicSemesterId_fkey" FOREIGN KEY ("academicSemesterId") REFERENCES "academic_semesters"("id") ON DELETE CASCADE ON UPDATE CASCADE;
